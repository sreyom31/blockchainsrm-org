  ...
  return (
    <div className="grid auto-cols-auto lg:grid-cols-2 gap-20 xl:gap-40 p-10 lg:p-12 xl:p-16 2xl:p-24 mt-24">
      ...
      <div className="box p-6 text-white">
        ...
        <p className="text-xl md:text-lg lg:text-xl">
          ...
          id odio dolorem nemo facere quae eveniet fuga? Optio quae molestias
    ...
    <div className="box p-6 text-white">
        ...
        <p className="text-xl md:text-lg lg:text-xl">
          ...
          cupiditate laudantium maxime consectetur magnam ducimus, explicabo
          numquam veritatis recusandae culpa blanditiis repellendus minima
